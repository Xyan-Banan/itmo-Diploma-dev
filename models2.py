...
class Group(models.Model):
    ...
    teacher = models.ForeignKey('User', models.DO_NOTHING, db_column='teacher')
...
class PracticeForGroup(models.Model):
    id_practice = models.ForeignKey(Practice, models.DO_NOTHING, db_column='id_practice', primary_key=True)
